...
- github_manage_code (action: create_branch)
- github_manage_code (action: create_pr)
...
| `github_manage_code` (action="get_info") | Determine project language and conventions |

### PR Creation

| Tool | Purpose |
|------|---------|
| `github_manage_code` (action="create_branch") | Create feature branch for changes |
| `github_manage_code` (action="create_pr") | Submit documentation PR |
| `github_manage_issues` (action="create_issue") | Create tracking issue if needed |
