...
- github_manage_code (action: list_branches)
- symbol_analysis
...
Use `github_manage_code` (action="get_info") and search for:
...
| `github_manage_code` (action="get_info") | Repo metadata, default branch, topics |
| `github_manage_code` (action="list_branches") | Identify release branches |
