...
If user accepts, use `github_create_issue`:
...
If there's an existing documentation issue, use `github_add_comment` to add the README content.
...
| Tool | Purpose |
|------|---------|
| `github_get_repo_info` | Repository metadata, topics, language |
...
| Tool | Purpose |
|------|---------|
| `github_create_issue` | Create README improvement issue |
| `github_add_comment` | Add to existing documentation issues |
