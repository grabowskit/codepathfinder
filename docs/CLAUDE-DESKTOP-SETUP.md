...
- CodePathfinder running locally or on your server
...
4. Enter:
   - **Name:** `CodePathfinder`
   - **URL:** `http://localhost:8000/mcp` (or your server's URL)
5. Click **Add**
...
1. Log in to your CodePathfinder instance
...
**Solutions**:
1. Verify the URL matches your instance: `http://localhost:8000/mcp`
...
**Solutions**:
1. Verify your project is indexed on your CodePathfinder instance
...
- **Documentation**: the `docs/` directory in the repository
- **Support**: [GitHub Issues](https://github.com/grabowskit/pathfinder-prototype/issues)
