...
- Use `github_manage_issues` (action="create_issue") to log significant findings for tracking
- Use `github_manage_issues` (action="add_comment") to add review comments to existing PRs/issues''',
        'allowed_tools': ['semantic_code_search', 'read_file_from_chunks', 'symbol_analysis', 'github_manage_issues'],
...
## GitHub Integration:
When you find significant optimizations, use `github_manage_issues` (action="create_issue") to create a tracking issue with:
...
Create a comprehensive GitHub issue using `github_manage_issues` (action="create_issue").
...
- Use `github_manage_code` (action="get_info") to understand the repository context
- Use `github_manage_issues` (action="create_issue") to create the final issue''',
        'allowed_tools': ['semantic_code_search', 'map_symbols_by_query', 'github_manage_issues', 'github_manage_code'],
