...
class BetaSignupView(View):
    ...
    def post(self, request):
        ...
        # Simple validation (fields are optional per 0648bab commit message)
        errors = {}
        if not name:
...
Name: {name}
Email: {email}
GitHub Repository: {github_repo if github_repo else 'Not provided'}
...
{interest if interest else 'Not provided'}
