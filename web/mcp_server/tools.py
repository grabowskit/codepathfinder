...
For bug reports (issue_type="bug"), include: steps_to_reproduce, expected_behavior, actual_behavior, environment
For feature requests (issue_type="feature"), include: use_case, proposed_solution, alternatives_considered

The tool will format the body using the appropriate template based on issue_type.
Use github_get_labels first to discover valid labels for the repository.""",
        "inputSchema": {
            "type": "object",
            "properties": {
                "project_name": {
                ...
                "body": {
                    "type": "string",
                    "description": "Issue body/description. If issue_type is set, this becomes the summary section."
                },
                "labels": {
                    "type": "array",
                    "items": {"type": "string"},
                    "description": "Optional list of label names. Use github_get_labels to see available options."
                },
                "issue_type": {
                    "type": "string",
                    "enum": ["bug", "feature", "general"],
                    "description": "Issue type for template formatting (default: general)"
                },
                "draft": {
                    "type": "boolean",
                    "description": "If true, return a preview instead of creating the issue"
                },
                "code_references": {
                    "type": "array",
                    "items": {
                        ...
                        "properties": {
                            ...
                            "description": {"type": "string", "description": "Description of the code reference"}
                        },
                        "required": ["file_path"]
                    },
                    "description": "Code references to include in the issue. Use semantic_code_search and read_file_from_chunks to gather relevant code."
                },
                "steps_to_reproduce": {
                    "type": "string",
                ...
                "expected_behavior": {
                    "type": "string",
                    "description": "For bug reports: expected behavior"
                },
                "actual_behavior": {
                    "type": "string",
                    "description": "For bug reports: actual/observed behavior"
                },
                "environment": {
                    "type": "string",
                    "description": "For bug reports: environment details (OS, version, etc.)"
                },
                "use_case": {
                    "type": "string",
                    "description": "For feature requests: the use case/problem being solved"
                },
                "proposed_solution": {
                    "type": "string",
                    "description": "For feature requests: proposed solution"
                },
                "alternatives_considered": {
                    "type": "string",
                    "description": "For feature requests: alternative approaches considered"
                }
            },
    ...
    },
    {
        ...
        "description": "Get available labels for a project's repository. Use this to discover valid labels before creating issues.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "project_name": {
...
def github_get_labels(
    ...
    try:
        ...
        raise ToolError(f"Failed to get labels: {str(e)}")
        ...
        for s in status_order:
            if s in status_groups:
                ...
                for proj in status_groups[s]:
                    ...
                    lines.append(f"  • {proj.name} (ID: {proj.id}){stats_str}")
                lines.append("")
...
TOOLS = {
    ...
    'github_get_labels': github_get_labels,
